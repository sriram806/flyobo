...
export default function PackageBarChart({
  dataPoints = [], // expects [{ monthLabel, count }]
  ...
  const options = {
    ...
    scales: {
      x: {
        ticks: { maxRotation: 0, minRotation: 0, color: "#6b7280", font: { size: 10 } },
      },
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-4 gap-4">
      ...
      {/* RIGHT — GROWTH RATE */}
      <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-xl border border-gray-300 dark:border-gray-700 flex flex-col items-center justify-center">
