...
export default function ResultsToolbar({ filteredCount, sortBy, setSortBy, view, setView }) {
  return (
    ...
    >
      ...
      {/* Right Section - Sorting & View Options */}
      <div className="flex flex-wrap items-center gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none rounded-xl border border-gray-300 dark:border-gray-700 
              bg-white dark:bg-gray-800 
              px-4 py-2.5 text-sm font-medium 
              focus:outline-none focus:ring-2 focus:ring-sky-500/60 
              pr-10 text-gray-800 dark:text-gray-200 
        ...
        <div
          ...
          p-1 rounded-xl shadow-inner transition-all"
        >
          <button
