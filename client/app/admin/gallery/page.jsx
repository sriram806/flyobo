...
export default function AdminGalleryPage() {
  const API_BASE = NEXT_PUBLIC_BACKEND_URL || process.env.NEXT_PUBLIC_BACKEND_URL
            ...
            <form onSubmit={onSubmit} className="mt-6 grid grid-cols-1 gap-3 md:grid-cols-12">
              ...
              <div className="md:col-span-1 flex gap-2">
                <button
                  type="submit"
                  disabled={loading}
                  className={`flex-1 rounded-lg bg-blue-600 hover:bg-blue-700 px-3 py-2 text-white ${loading ? "opacity-60 cursor-not-allowed" : ""
                    }`}
                >
