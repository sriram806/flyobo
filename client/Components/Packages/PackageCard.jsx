...
export default function PackageCard({ pkg, loading }) {
  ...
  const onToggleFav = async (e) => {
    ...
    try {
      ...
      if (isFav) {
        await axios.delete(
          `${API_URL}/user/favourite-packages/${packageId}`,
          {
            ...getAuthConfig(),
            data: { packageId },
          }
          ...
          <>
            ...
            <div className="absolute top-3 right-3">
              <button
                ...
                className={`inline-flex items-center justify-center w-11 h-11 rounded-full shadow-lg backdrop-blur-sm transition-all duration-300 ${isFav
