      ...
      >
        ...
        <div className="flex items-center justify-between">
          <div className="text-lg font-bold text-gray-900 dark:text-gray-100 flex items-center gap-2">
            <Grid className="text-sky-500 w-5 h-5" />
            Filters
          </div>

          <button
            onClick={onReset}
            className="text-sm inline-flex items-center gap-1.5 rounded-lg 
              border border-gray-300 dark:border-gray-700 
              px-3 py-2 bg-white/70 dark:bg-gray-900/50 
        ...
        {/* SEARCH */}
        <div>
          <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2 mb-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border 
                ...
                focus:outline-none focus:ring-2 focus:ring-sky-500/60 transition-all"
            />
          </div>
        </div>
            ...
            {[0, 3, 3.5, 4, 4.5].map((rating) => (
              <button
                ...
                className={`flex flex-col items-center justify-center p-2 rounded-lg border 
                  ...
                  ${
                    minRating === rating
                      ? "border-sky-500 bg-sky-50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-300 shadow-sm"
                      : "border-gray-300 dark:border-gray-700 hover:border-sky-300 dark:hover:border-sky-600"
                  }`}
              >
                <Star
                  className={`w-4 h-4 ${
                    minRating === rating ? "fill-current text-yellow-500" : ""
                  }`}
                />
              ...
              return (
                <button
                  ...
                  className={`px-3 py-2 rounded-lg border text-sm transition-all 
                    ${
                      isSelected
                        ? "border-sky-500 bg-sky-50 dark:bg-sky-900/40 text-sky-600 dark:text-sky-400 shadow-sm"
                        : "border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-100 hover:border-sky-300 dark:hover:border-sky-600"
                    }`}
                >
                  {label}
                </button>
        ...
        {/* DESTINATION SCOPE – ONLY DOMESTIC & INTERNATIONAL */}
        <div>
          <div className="text-sm font-semibold text-gray-900 dark:text-gray-100 flex items-center gap-2 mb-3">
            <Grid className="text-emerald-500 w-4 h-4" />
            Region
          </div>
          ...
          <div className="grid grid-cols-3 gap-2">
            {[
              ...
              <button
                key={value}
                onClick={() => setDestinationScope(value)}
                className={`px-3 py-2 rounded-lg border text-sm transition-all text-left
                  ${
                    destinationScope === value
                      ? "border-sky-500 bg-sky-50 dark:bg-sky-900/40 text-sky-700 dark:text-sky-200 shadow-sm"
                      : "border-gray-300 dark:border-gray-700 text-gray-800 dark:text-gray-100 hover:border-sky-300 dark:hover:border-sky-600"
                  }`}
              >
                {label}
